...
def is_torch_uint8(value: object) -> bool:
    """Return whether value is a uint8 torch tensor without requiring torch."""
    try:
        import torch
    except ImportError:
        return False
...
def resize_with_pad_torch(
    ...
    try:
        ...
        raise RuntimeError("resize_with_pad_torch requires the optional torch runtime") from exc
