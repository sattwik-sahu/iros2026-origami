...
> This page describes upstream OpenPI WebSocket development. Origami competition
> submission images must use `scripts/serve_policy_zenoh.py` and the
> `origami-zenoh-v1` contract documented in `../../PARTICIPANT_GUIDE.md`.
