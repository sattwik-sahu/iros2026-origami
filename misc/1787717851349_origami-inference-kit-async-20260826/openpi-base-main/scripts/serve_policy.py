...
class Args:
    ...
    # Interface to bind. Robot deployments use 127.0.0.1 with host networking.
    host: str = "0.0.0.0"
...
def main(args: Args) -> None:
    ...
    if isinstance(args.policy, Checkpoint):
        policy_metadata["action_horizon"] = _config.get_config(args.policy.config).model.action_horizon
