...
## Origami participant integration

For an Origami competition submission, use the formal Zenoh adapter and bundled
image definition:

```text
scripts/serve_policy_zenoh.py
scripts/docker/submission_zenoh_entrypoint.sh
scripts/docker/submission-zenoh-bundled.Dockerfile
```

The complete build command and public observation/action contract are documented
in `../PARTICIPANT_GUIDE.md` and
`../docs/competition_participant_complete_guide.md`. Teams must provide their
own checkpoint and runtime assets.
...
| $\pi_{0.5}$-LIBERO      | Inference   | $\pi_{0.5}$ model fine-tuned for the [LIBERO](https://libero-project.github.io/datasets) benchmark: gets state-of-the-art performance (see [upstream LIBERO README](https://github.com/Physical-Intelligence/openpi/blob/main/examples/libero/README.md)) | `gs://openpi-assets/checkpoints/pi05_libero`      |
...
```
You can also test this out in the [upstream example notebook](https://github.com/Physical-Intelligence/openpi/blob/main/examples/inference.ipynb).

We provide detailed upstream examples for running inference of our pre-trained checkpoints on [DROID](https://github.com/Physical-Intelligence/openpi/blob/main/examples/droid/README.md) and [ALOHA](https://github.com/Physical-Intelligence/openpi/blob/main/examples/aloha_real/README.md) robots.
...
This competition kit carries the OpenPI inference subset, not the complete
upstream training workspace. The training commands and example paths below are
upstream references and require a full checkout of
...
For running the LIBERO eval in particular, the upstream repository provides a Dockerized workflow that handles both the policy server and the evaluation script together. See the [upstream LIBERO README](https://github.com/Physical-Intelligence/openpi/blob/main/examples/libero/README.md) for more details.
...
The upstream repository provides more examples for fine-tuning and inference:
- [ALOHA Simulator](https://github.com/Physical-Intelligence/openpi/tree/main/examples/aloha_sim)
- [ALOHA Real](https://github.com/Physical-Intelligence/openpi/tree/main/examples/aloha_real)
- [UR5](https://github.com/Physical-Intelligence/openpi/tree/main/examples/ur5)
