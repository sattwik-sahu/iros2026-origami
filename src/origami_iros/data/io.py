...
:class:`~origami_iros.models._typing.VLTA_Input` /
:class:`~origami_iros.models._typing.VLTA_Output` tensorclasses and a flat
:class:`~origami_iros.models._typing.DictData` dictionary of numpy arrays and
...
from origami_iros.models._typing import VLTA_Input as VLTA_Input
from origami_iros.models._typing import VLTA_Output as VLTA_Output
