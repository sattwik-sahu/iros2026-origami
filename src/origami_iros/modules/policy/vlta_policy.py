...
from origami_iros.modules.main import VLTA_Encoder
...
class VLTAPolicy(nn.Module):
    def __init__(
        ...
        deform_vit = TinyViT_TactileImageEncoder(
            image_size=(480, 1200), patch_size=tactile_patch_size, n_hands=n_hands, n_fingers=n_fingers
        )
        raw_vit = TinyViT_TactileImageEncoder(
            image_size=(480, 1600), patch_size=tactile_patch_size, n_hands=n_hands, n_fingers=n_fingers
        )
